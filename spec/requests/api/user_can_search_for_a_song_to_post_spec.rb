RSpec.describe 'GET /api/tracks', type: :request do
  describe 'successfully get a list of songs' do
    ...
    it 'is expected to return a name of the song ' do
      expect(
        response_json['tracks'][0]['name']
      ).to eq 'All I Want for Christmas Is You'
    end
    ...
    it 'is expected to return an image of the song album' do
      expect(
        response_json['tracks'][0]['image']
      ).to eq 'https://i.scdn.co/image/ab67616d0000b2734246e3158421f5abb75abc4f'
    end

    it 'is expected to return a preview url of the song' do
      expect(
        response_json['tracks'][0]['preview']
      ).to eq 'https://p.scdn.co/mp3-preview/bbafd15ff484394a0ca106d5fef0a81eeea4ef5b?cid=9165f2ed52ac4632b2c23038c2fbe1d9'
    end
  end
end
