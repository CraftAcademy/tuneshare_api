User.create(email: 'jackson.finch@gmail.com', password: 'password')
User.create(email: 'viktor@karlsson.com', password: 'password')
User.create(email: 'salindholm@gmail.com', password: 'password')
User.create(email: 'rithreaksa@gmail.com', password: 'password')
User.create(email: 'kyungin@gmail.com', password: 'password')
